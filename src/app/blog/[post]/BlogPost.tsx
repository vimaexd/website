    ...
    <PageContainer>
      <div className='flex gap-8 flex-col lg:flex-row items-center lg:items-start'>
        ...
        <div className='w-full gap-4 flex flex-col'>
          <div className='w-full bg-neutral-800 rounded-lg px-4 py-4 flex items-center justify-between'>
            <h3 className='font-semibold text-lg'>Author</h3>
            <div  className='flex items-center gap-2'>
              <Image src="/assets/pfp.png" width={32} height={32} alt="Profile picture" className='rounded-full'/>
              <p>mae</p>
            </div>
          </div>
          <div className='w-full bg-neutral-800 rounded-lg px-4 py-4 flex items-center justify-between'>
