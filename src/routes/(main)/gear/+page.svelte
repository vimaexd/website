...
<PageContainer>
	...
	<h2 class="font-semibold text-5xl">computers</h2>

	<!-- {/* stargazer */} -->
	<div class="grid grid-rows-2 sm:grid-rows-1 sm:grid-cols-2 min-h-64">
		<div class="space-y-2">
			<h3 class="font-semibold text-4xl">💫 stargazer</h3>

			<i>my main computer! evolving since 2019</i>
			<ul class="list-inside">
				<li>
					<i class="bx bx-chip"></i> Intel Core i7-9700k
				</li>
				<li>
					<i class="bx bx-microchip"></i> 2x8GB Corsair Vengeance @ 3000MHz
				</li>
				<li>
					<i class="bx bx-microchip"></i> NVIDIA GeForce GTX 1080
				</li>
				<li>
					<i class="bx bx-microchip"></i> MSI Z370-A PRO
				</li>
				<li>
					<i class="bx bx-hdd"></i> 240GB SSD
				</li>
				<li>
					<i class="bx bx-hdd"></i> 480GB SSD
				</li>
				<li>
					<i class="bx bx-hdd"></i> 1TB HDD
				</li>
				<li>
					<i class="bx bx-hdd"></i> 1TB HDD (external)
				</li>
				<li>
					<i class="bx bx-hdd"></i> 2TB HDD (external)
				</li>
				<li>
					<i class="bx bx-wind"></i> DEEPCOOL AK620 WH
				</li>
				<li>
					<i class="bx bx-box"></i> NZXT H5 Flow
				</li>
				<li>
					<i class="bx bx-disc"></i> Windows 11 Pro
				</li>
			</ul>
		</div>
	...
	<div class="grid grid-rows-2 sm:grid-rows-1 sm:grid-cols-2 min-h-64">
		<div class="space-y-2">
			<h3 class="font-semibold text-4xl">🌃 nebula</h3>

			<i>my laptop</i>
			<ul class="list-inside">
				<li>
					<i class="bx bx-laptop"></i> 2023 MacBook Pro
				</li>

				<li>
					<i class="bx bx-chip"></i> Apple M2 Pro
				</li>

				<li>
					<i class="bx bx-microchip"></i> 16GB RAM
				</li>

				<li>
					<i class="bx bx-microchip"></i> 512GB storage
				</li>
			</ul>
		</div>
	...
	<div class="grid grid-rows-2 sm:grid-rows-1 sm:grid-cols-2 min-h-64">
		<div class="space-y-2">
			<h3 class="font-semibold text-4xl">🌌 aurora</h3>

			<i>my home server made out of spare parts!</i>
			<ul class="list-inside">
				<li>
					<i class="bx bx-chip"></i> AMD Ryzen 5 1600
				</li>

				<li>
					<i class="bx bx-microchip"></i> 8GB RAM
				</li>

				<li>
					<i class="bx bx-microchip"></i> NVIDIA GeForce GTX 1070
				</li>

				<li>
					<i class="bx bx-hdd"></i> 4TB storage total
				</li>

				<li>
					<i class="bx bx-disc"></i> Proxmox (Debian)
				</li>
			</ul>
		</div>
	...
	<div class="space-y-2 grid grid-cols-2">
		<div>
			<h3 class="font-semibold text-2xl">Accessories for stargazer</h3>
		...
		<div>
			<h3 class="font-semibold text-2xl">Misc</h3>
			<ul class="list-disc list-inside">
	...
	<div class="flex flex-row justify-between">
		<div class="space-y-4 flex-grow">
			<h3 class="font-semibold text-4xl">Software</h3>
			<h4 class="font-semibold text-xl">🎵 for music:</h4>
			<ul class="list-disc list-inside">
				...
				<li class="text-sm">lots of other plugins</li>
			</ul>

			<h4 class="font-semibold text-xl">📽️ for videos:</h4>
			<ul class="list-disc list-inside">
				<li>Blender</li>
				<li>Premiere Pro</li>
				<li>After Effects</li>
			...
			<p class="text-sm">among others</p>
		</div>
		<div class="h-auto w-1/2 gap-8 hidden lg:grid">
			<div class="relative">
				<img
					src="/assets/ableton_screenshot.png"
					class="rounded-xl object-cover object-top"
