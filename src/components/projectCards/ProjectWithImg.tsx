...
export default function ProjectWithImg(props: ProjectPropsImg) {
  return (
    <div className='relative'>
      <div className='bg-slate-700 w-full rounded-md sm:h-52
        min-h-max flex flex-col justify-end bg-cover shadow-xl flex-grow-0 progressive-blur
        anim-projects backface-hidden translate-z-0' style={{
