...
export default function FakeAd() {
    ...
    useEffect(() => {
        ...
        setAd(fakeAds.list[index]);
    }, []);

    if (!visible)
        return (
            <div className="flex justify-between">
                <p className="text-xs text-neutral-600">fake ads are hidden</p>
                <p
                    className="text-xs text-neutral-600 hover:text-white hover:underline cursor-pointer"
        ...
        <div>
            {ad == undefined
               ...
               : ad.filename.endsWith(".webm") ? (
                   <video
                       ...
                       autoPlay={true}
                       loop={true}
                       aria-description="A fake advertisement video"
                   >
                       <source
            ...
            <div className="flex justify-between mt-1">
                <p className="text-xs text-neutral-400">
                    fake ad by {(ad != undefined) ? ad.author : "..."}
                </p>
                <p
