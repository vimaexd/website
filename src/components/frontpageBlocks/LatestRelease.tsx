...
export default function latest_release() {
  return (
    <div className='w-full bg-str-bleck-200 rounded-lg bg-center bg-cover' style={{
      backgroundImage: "linear-gradient(0deg, rgba(0,0,0,0.75) 0%, rgba(0,0,0,0.2) 100%), url(/assets/music/covers/moon.png)"
    }}>
      <div className='w-full h-full p-6 backdrop-blur-xl rounded-lg flex flex-row gap-4'>
        <Image src="/assets/music/covers/moon.png" width={128} height={128} alt={'Cover art'} quality={100} className='rounded-lg'></Image>
